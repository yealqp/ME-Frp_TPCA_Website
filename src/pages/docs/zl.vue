  ...
  <div>
    ...
    <div class="mb-8">
      <div class="flex items-center space-x-4 mb-4">
        <img 
          src="https://alist.yealqp.cn/d/images/views/zerosnow/znext(1).png?sign=hhBbX46sFLJ48Y-Vgvtb4zuTTIcJqw9bz8r-qadywXY=:0" 
...
// 预览图数据
const previewImages = [
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/login.png', alt: '登录界面' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/znext-photo.png', alt: '主页面' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/tunnel.png', alt: '隧道管理' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/node.png', alt: '节点选择' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/create.png', alt: '创建隧道' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/password.png', alt: '安全访问' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/help.png', alt: '帮助页面' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/config.png', alt: '配置设置' },
  { src: 'https://image.mefrp-tpca.yealqp.cn/image/views/zerosnow/about.png', alt: '关于页面' }
]
